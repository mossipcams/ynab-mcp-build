...
export async function getTransaction(
  ...
  return {
    transaction: compactObject({
      ...
      flag_name: transaction.flagName,
      transfer_account_id: transaction.transferAccountId,
      transfer_transaction_id: transaction.transferTransactionId,
      matched_transaction_id: transaction.matchedTransactionId,
      import_id: transaction.importId,
      import_payee_name: transaction.importPayeeName,
      import_payee_name_original: transaction.importPayeeNameOriginal,
      debt_transaction_type: transaction.debtTransactionType,
      deleted: transaction.deleted,
      subtransactions: transaction.subtransactions?.map((subtransaction) =>
        compactObject({
          id: subtransaction.id,
          amount: formatAmountMilliunits(subtransaction.amount),
          memo: subtransaction.memo,
          payee_id: subtransaction.payeeId,
          payee_name: subtransaction.payeeName,
          category_id: subtransaction.categoryId,
          category_name: subtransaction.categoryName,
          transfer_account_id: subtransaction.transferAccountId,
          transfer_transaction_id: subtransaction.transferTransactionId,
