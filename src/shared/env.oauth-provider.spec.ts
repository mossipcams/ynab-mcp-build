...
describe("OAuth provider environment", () => {
  ...
  it("resolves Cloudflare Access OIDC upstream configuration", () => {
    ...
    expect(env.accessOidc).toMatchObject({
      ...
      discoveryUrl: "https://mossipcams.cloudflareaccess.com/cdn-cgi/access/sso/oidc/access-client-id/.well-known/openid-configuration",
      teamDomain: "mossipcams.cloudflareaccess.com"
    });
  });
