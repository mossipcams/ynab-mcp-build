...
describe("OAuth provider environment", () => {
  ...
  it("resolves Cloudflare Access OIDC upstream configuration", () => {
    ...
    expect(env.accessOidc).toMatchObject({
      authorizationUrl: "https://access-team.example.com/cdn-cgi/access/sso/oidc/authorize",
      clientId: "access-client-id",
      clientSecret: "access-client-secret",
      jwksUrl: "https://access-team.example.com/cdn-cgi/access/certs",
      tokenUrl: "https://access-team.example.com/cdn-cgi/access/sso/oidc/token"
    });
  });
});
