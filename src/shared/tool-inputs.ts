...
export const monthSelectorSchema = z.union([
  z.literal("current"),
  monthFieldSchema,
]);
...
export const fieldProjectionSchema = <TFields extends EnumValues>(
  fields: TFields,
) => z.array(z.enum(fields)).optional();

export const paginatedProjectionSchema = <TFields extends EnumValues>(
  fields: TFields,
) => ({
  ...planIdSchema,
  ...paginationSchema,
