...
export function hasProjectionControls<FieldName extends string>(options: CollectionOptions<FieldName>) {
  return Boolean(options.fields?.length) || options.includeIds === false;
}

export function hasPaginationControls<FieldName extends string>(options: CollectionOptions<FieldName>) {
...
export function paginateEntries<Entry>(entries: Entry[], options: PaginationOptions = {}) {
