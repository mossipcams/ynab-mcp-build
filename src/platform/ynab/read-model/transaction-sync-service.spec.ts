...
function createSyncStateRepository(
  overrides: Partial<Record<keyof ReturnType<typeof baseSyncStateRepository>, unknown>> = {}
) {
  return {
...
describe("transaction sync service", () => {
  ...
  it("upserts changed rows and advances the cursor after writes succeed", async () => {
    ...
    expect(deltaClient.listTransactionsDelta).toHaveBeenCalledWith("plan-1", 123);
