...
const AmountPresentationSchema = z.object({
...
const AccountSchema = z.object({
  ...
  balance: z.number()
}).merge(AmountPresentationSchema).passthrough();
...
export const YnabPlansResponseSchema = z.object({
  data: z.object({
...
export const YnabAccountsResponseSchema = z.object({
  data: z.object({
    accounts: z.array(AccountSchema)
  }).passthrough()
}).passthrough();

export const YnabCategoriesResponseSchema = z.object({
  data: z.object({
    category_groups: z.array(CategoryGroupSchema)
  }).passthrough()
}).passthrough();

export const YnabTransactionsResponseSchema = z.object({
  data: z.object({
    transactions: z.array(TransactionSchema)
  }).passthrough()
}).passthrough();

export const YnabScheduledTransactionsResponseSchema = z.object({
  data: z.object({
